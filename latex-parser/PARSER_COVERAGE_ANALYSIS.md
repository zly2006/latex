...
#### 希腊字母 (100+)
- ✅ 小写: α, β, γ, δ, ϵ, ζ, η, θ, ι, κ, λ, μ, ν, ξ, ο（含 `\omicron`）, π, ρ, σ, τ, υ, ϕ, χ, ψ, ω
- ✅ 大写: Γ, Δ, Θ, Λ, Ξ, Π, Σ, Υ, Φ, Ψ, Ω
- ✅ KaTeX 大写别名: `\Alpha`, `\Beta`, `\Epsilon`, `\Zeta`, `\Eta`, `\Iota`, `\Kappa`, `\Mu`, `\Nu`, `\Omicron`, `\Rho`, `\Tau`, `\Chi`
- ✅ 变体: ε/ϵ, θ/ϑ, π/ϖ, ρ/ϱ, σ/ς, φ/ϕ, `\varGamma`–`\varOmega`
